...
export const metadata: Metadata = {
  title: 'إدارة التصنيفات | FULLSCO Admin',
  description: 'لوحة تحكم إدارة تصنيفات المنح الدراسية في منصة FULLSCO',
};
          ...
          <table className="w-full">
            <thead>
              <tr className="border-b bg-muted/50">
                ...
                <th className="py-3 px-4 text-start font-medium text-right">الإسم المختصر</th>
                ...
                <td className="py-3 px-4">
                  <div className="flex items-center gap-3">
                    <div className="h-10 w-10 bg-primary/20 rounded-full flex items-center justify-center">
                      <span className="i-lucide-book h-5 w-5 text-primary" />
                    </div>
                    <div>
                      <p className="font-medium">علوم الحاسوب</p>
                    </div>
                  </div>
                </td>
              ...
              <tr className="border-b hover:bg-muted/50 transition-colors">
                <td className="py-3 px-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="font-medium">الطب</p>
                    </div>
                  </div>
                </td>
              ...
              <tr className="border-b hover:bg-muted/50 transition-colors">
                <td className="py-3 px-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="font-medium">الهندسة المدنية</p>
                    </div>
                  </div>
                </td>
                <td className="py-3 px-4">civil-engineering</td>
